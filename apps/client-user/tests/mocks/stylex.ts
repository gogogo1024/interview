...
const types = {
	color: <T>(value: T): T extends { default: infer D } ? D : T => {
		if (value && typeof value === "object" && "default" in value) {
			return (value as Record<string, unknown>).default as ReturnType<typeof types.color<T>>;
		}
		return value as ReturnType<typeof types.color<T>>;
	},
};
...
export { create, defineVars, keyframes, props, types };
